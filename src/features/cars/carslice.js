...
export const fetchALLCars = createAsyncThunk("cars/getAPI", async () => {
  const response = await axios.get("https://6383958b6e6c83b7a9974a62.mockapi.io/data/categories");
...
export const saveNewCar = createAsyncThunk(
  "cars/createAPI",
  async (payload) => {
    const response = await axios.post("https://6383958b6e6c83b7a9974a62.mockapi.io/data/categories", payload);
    return response.data;
  }
);
...
export const updateCar = createAsyncThunk("cars/updateAPI", async (payload) => {
  const response = await axios.put(
    `https://6383958b6e6c83b7a9974a62.mockapi.io/data/categories/${payload.id}`,
    payload
  );
  return response.data;
});
...
export const deleteCar = createAsyncThunk("cars/deleteAPI", async (id) => {
  const response = await axios.delete(`https://6383958b6e6c83b7a9974a62.mockapi.io/data/categories/${id}`);
  return id;
});
